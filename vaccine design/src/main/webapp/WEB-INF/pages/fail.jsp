		...
		<div class="d-flex justify-content-center h-100">
			<div class="card">
				<div class="card-header">
					<h3 style="color:black;">Hey,Citizen of India your Application is got Failed due to some technical Or the information provided is not correct now go back and Application get your appointment</h3>
